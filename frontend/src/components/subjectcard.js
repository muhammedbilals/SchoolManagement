...
const SubjectCard = ({ subject, onEdit, onDelete }) => {
  return (
    <div className= "h-20 content-center bg-gray-700 text-white p-4 rounded-lg shadow-md relative">
      {/* <h3 className="text-xl font-semibold overflow-hidden overflow-ellipsis whitespace-nowrap">{subject.description}</h3> */}
      <p className="text-md">{subject.subjectCode}</p>
